...
error_reporting(0);
if (!file_exists("6310638973")) {
$g = readline("6310638973 >>>: ");
file_put_contents("6310638973", $g);
}
if (!file_exists("ch")) {
file_put_contents("ch", "check team");
}
if (!file_exists("6424252869:AAEqzn7BXDN0lfolf0RnDM9R1fDI7vI3ejA")) {
$g = readline("Token >>>: ");
file_put_contents("6424252869:AAEqzn7BXDN0lfolf0RnDM9R1fDI7vI3ejA", $g);
}
if (!file_exists("type")) {
